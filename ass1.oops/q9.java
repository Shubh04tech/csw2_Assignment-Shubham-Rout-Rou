...
public class Enrollment implements EnrollmentSystem {
    ...
    public void enrollStudent(Student student, Course course) {
        ...
        System.out.println(student.getName() + " enrolled in " + course.getName() + " (code: " + course.getCode() + ").");
    }

    @Override
    public void dropStudent(Student student, Course course) {
        course.dropStudent();
        System.out.println(student.getName() + "  dropped from " + course.getName() + " (code: " + course.getCode() + ").");
    }
